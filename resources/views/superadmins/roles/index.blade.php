    ...
    <div class="p-2 bg-slate-100 sm:rounded-lg m-1 w-full mx-1 shadow-sm">
        <div class="relative w-full">
            <div class="absolute right-0">
                <a href="{{ route('superadmin.roles.create') }}" class="bg-blue-500 text-white rounded-md py-1 px-2 my-4 hover:bg-blue-400 hover:text-blue-700 hover:border-blue-200 hover:border-4">
                    Add Role
                </a>
            </div>
        </div>
