        ...
        <table class="table-auto w-full mt-6">
            ...
            <tr class="border-b-2 border-gray-300">
                ...
                <td class="py-0 grid grid-cols-2">
                    <a href="{{ route('superadmin.permissions.edit', $permission->id) }}" class="text-blue-500 bg-slate-300 m-px rounded text-center font-bold">
                        Edit
                    </a>
                    <form class="bg-red-600 px-0 m-px text-center rounded" action="{{route('superadmin.permissions.destroy', $permission->id)}}" method="post" onsubmit="return confirm('Are you sure! You need to Delete this Record?!')">
                        @csrf
                        @method('DELETE')
